            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (auth()->user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.diskon.index')" :active="request()->routeIs('admin.diskon.*')">
                            {{ __('Diskon') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.diskon.index')" :active="request()->routeIs('admin.diskon.*')">
                    {{ __('Diskon') }}
                </x-responsive-nav-link>
            @endif
